...
public enum TransactionType {
     ...
     */
    OBGYNVISIT_HCP_VIEW ( 2501, "OBGYN office visit viewed by HCP", true ),

    /**
     * obgyn visit is created by an hcp
     */
    OBGYNVISIT_CREATE ( 2502, "OBGYN office visit created", true ),

    /**
     * An obgyn office visit is deleted
     */
    OBGYNVISIT_DELETE ( 2503, "OBGYN office visit deleted", true ),

    /**
     * Exisiting obgyn visit is edited
     */
    OBGYNVISIT_EDIT ( 2504, "OBGYN office visit edited", true ),
