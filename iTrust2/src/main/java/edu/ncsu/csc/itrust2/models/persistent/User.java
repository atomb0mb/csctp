...
public class User extends DomainObject<User> implements Serializable {
    ...
    /**
     * True if the user is an HCP, OD, OPH, or OBGYN
     * 
     * @return true if the user role matches HCP, OD, OPH, or OBGYN
     */
    public boolean isDoctor () {
        return ( role == Role.ROLE_HCP || role == Role.ROLE_OD || role == Role.ROLE_OPH || role == Role.ROLE_OBGYN );
    }
