...
public class HCPLaborAndDeliveryStepDefs extends CucumberTest {
     ...
     * @throws InterruptedException
     */
    @Then ( "^he enters (.+) (.+) (.+) (.+) (.+) (.+) (.+) (.+) (\\d+) (\\d+) (\\d+) (\\d+) (\\d+) (.+) (.+) (\\d+) (\\d+) (\\d+) (\\d+) (\\d+)$" )
    public void addReport ( final String laborDate, final String laborTime, final String deliveryDate,
            ...
            final int twinSystolic, final int twinDiastolic ) throws InterruptedException {
        waitForAngular();
        ...
        driver.findElement( By.cssSelector( "input[type=radio][id=" + twin + "]" ) ).click(); // whether
                                                                                              // there
                                                                                              // are
                                                                                              // twins
